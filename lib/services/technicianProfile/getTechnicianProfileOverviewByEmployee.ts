...
/**
 * Retrieves the complete aggregated read model for a TechnicianProfile by employeeId.
 *
 ...
 *   - Returns `TechnicianProfileOverview | null` if employee does not exist,
 *     has no TechnicianProfile, or belongs to another workspace.
 *   - Zero mutation side effects.
 */
export async function getTechnicianProfileOverviewByEmployee(
    workspaceId: string,
    employeeId: string,
    ...
    // --- Tenant-Scoped Aggregate Lookup by Employee ID ---
