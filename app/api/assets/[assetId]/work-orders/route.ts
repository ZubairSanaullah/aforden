...
import { getAssetWorkOrders } from "@/lib/services/asset";
import {
    extractWorkspaceId,
    handleAssetApiError,
 ...
 *
 * Retrieves paginated WorkOrders linked to a specific Asset.
 */
export async function GET(
    ...
    try {
        ...
        const result = await getAssetWorkOrders(workspaceId, assetId, queryInput);
        ...
        return handleAssetApiError(error, "Get asset work orders");
    }
}
