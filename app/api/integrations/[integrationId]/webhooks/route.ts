 ...
 *
 * Lists registered inbound webhook endpoints for this integration.
...
export async function GET(
  ...
  try {
    ...
    const result = await IntegrationManagementService.listIntegrationWebhooks(
      workspaceId,
      integrationId
    );
    ...
    return handleIntegrationApiError(error, "GET /api/integrations/[integrationId]/webhooks");
  }
}
