 ...
 *
 * Disconnects an active provider and releases exclusive capabilities.
...
export async function POST(
  ...
  try {
    ...
    return handleIntegrationApiError(error, "POST /api/integrations/[integrationId]/disconnect");
  }
}
