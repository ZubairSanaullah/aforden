...
import { suspendWorkspace } from "@/lib/services/platform/workspaces";
...
/**
 * POST /api/platform/workspaces/[workspaceId]/suspend
 * Suspends tenant workspace operations (Tier-2 Mutating Action).
