...
import { completeWorkOrderAdmin } from "@/lib/services/technicianOperations";
import {
    extractWorkspaceId,
 ...
 *
 * Administrative completion of a work order (OWNER, ADMIN, MANAGER roles).
 */
export async function POST(request: Request, context: RouteContext) {
    try {
        ...
        const workOrder = await completeWorkOrderAdmin(workspaceId, workOrderId, validatedInput);
        ...
        return handleTechnicianOperationsApiError(error, "Admin complete work order");
    }
}
